...
tasks/Task.cpp, and will be put in the davis2pocolog namespace.
     * \details
     * The name of a TaskContext is primarily defined via:
     \verbatim
     deployment 'deployment_name'
         task('custom_task_name','davis2pocolog::Task')
     end
     \endverbatim
    ...
    protected:
        ...
        bool processTwist(const std::string &filename);
    ...
    public:
         ...
         */
        Task(std::string const& name = "davis2pocolog::Task");

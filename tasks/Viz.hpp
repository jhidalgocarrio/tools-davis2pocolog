...
#ifndef DAVIS2POCOLOG_VIZ_TASK_HPP
#define DAVIS2POCOLOG_VIZ_TASK_HPP

#include "davis2pocolog/VizBase.hpp"
...
namespace davis2pocolog{
     ...
     * Color encoding: RED_BLUE, GREEN_RED, BLUE_BLACK
     * \details
     * The name of a TaskContext is primarily defined via:
     \verbatim
     deployment 'deployment_name'
         task('custom_task_name','davis2pocolog::Viz')
     end
     \endverbatim
    ...
    public:
         ...
         */
        Viz(std::string const& name = "davis2pocolog::Viz");
